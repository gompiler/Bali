...
instance Convertible c e a b =>
         Convertible c e (Instructions' a) (Instructions' b) where
...
instance ( Convertible c e index index'
         ...
         Convertible c e (Instruction' index indexw label labelw intByte intShort arrayType count) (Instruction' index' indexw' label' labelw' intByte' intShort' arrayType' count') where
  convert c instruction =
    case instruction of
      Aaload              -> pure Aaload
